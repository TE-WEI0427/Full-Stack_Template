...
class PagePathProvider extends StatefulWidget {
  const PagePathProvider({super.key});

  @override
  State<PagePathProvider> createState() => _PagePathProviderState();
}

class _PagePathProviderState extends State<PagePathProvider> {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(
              ...
              title: const Text("Path Provider sample"),
            ),
            body: wbody));
  }
}
